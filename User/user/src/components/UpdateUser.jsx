...
class UpdateUser extends Component {
    ...
    componentDidMount(){
        UserServices.getUserById(this.state.id).then( (res) =>{
            let user = res.data;
            this.setState({userNid:user.userNid ,firstName:user.firstName,lastName:user.lastName,
                userAlias:user.userAlias,email:user.email,primaryGroup:user.primaryGroup, 
                secondaryGroup:user.secondaryGroup
            })
        })
    }
